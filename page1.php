    ...
    <section class="content container-fluid">
     ...
     <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
				...
				<?php 
				    $requet = "select * from contenaire where vu='0'";
				...
				<input type="hidden" value="<?=$pos['chemin']?>" name="ip"   >
                  <td> <?=$pos['id_cont']?></td>
...
<label class="checkbox-inline"><input type="radio" value ="yes" name="o">نعم  </label>
				  ...
				  <td> <select name="socite" >
				  <option value="1">الشركة1</option>
				  <option value="2">الشركة2</option>
				  <option value="2">الشركة3</option></select>
				  </td>
